...
'''
salario = 500#float(input('Qual seu salario: '))
aumento = ()
if salario <= 280:
    aumento = 0.2
    ...
    print('Erro!')
print(f' O salário antes do reajuste: {salario} \n O percentual de aumento aplicado: {aumento*100}%\n\
 O valor do aumento: {aumento*salario}\n O novo salário, após o aumento: {(aumento*salario)+salario}')
